...
- Project and build-configuration IDs include the release. Derive them from the target MPS version: `2026.1` → `MPS_20261`, `2026.2` → `MPS_20262`. Never assume which version `master` holds — it advances every release.
