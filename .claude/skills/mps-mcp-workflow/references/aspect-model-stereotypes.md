...
- Pass these to `mps_mcp_create_model` as `moduleName: "<hosting module>"` and `modelName: "<name>@<stereotype>"`. Example: `moduleName: "jetbrains.mps.tests"`, `modelName: "jetbrains.mps.tests@genplan"`.
