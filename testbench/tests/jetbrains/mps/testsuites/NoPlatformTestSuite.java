...
@SuiteClasses({
    ...
    jetbrains.mps.project.ModuleReferencesCacheTest.class,
    jetbrains.mps.ide.actions.NamespaceRenameHelperTest.class,
    jetbrains.mps.build.ant.ScriptSerializationTest.class,
