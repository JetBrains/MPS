...
@MPSLaunch
public class MatchRulesUnorderedChildren_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(MatchRulesUnorderedChildren_Test.class).projectPath(null).modelRef("r:914ee49a-537d-44b2-a5fb-bac87a54743d(jetbrains.mps.editorTest@tests)").reopenProject(false).build());

  public MatchRulesUnorderedChildren_Test() {
    super(ourParametersCacheExtension.getParametersCache());
  }

  @Test
  public void test_MatchRulesUnorderedChildren() throws Throwable {
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("2224057241668477125", "2224057241668477138");
    }
    @Override
